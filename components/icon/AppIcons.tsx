...
const AppIcons: { [key: string]: IconType } = {
  ...
  layoutSideLeft: VscLayoutSidebarLeft,
  layoutSideRight: VscLayoutSidebarRight,
  layoutSideLeftOff: VscLayoutSidebarLeftOff,
  layoutSideRightOff: VscLayoutSidebarRightOff,
