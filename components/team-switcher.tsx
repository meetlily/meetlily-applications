      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "w-[220px] border dark:border-gray-700 dark:text-white dark:bg-transparent justify-between",
              className
            )}
          >
        ...
        <PopoverContent className="w-[220px] p-0 border dark:border-gray-700 ">
          <Command>
            <CommandList>
              <CommandInput
