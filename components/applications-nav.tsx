...
interface ApplicationsNavProps extends React.HTMLAttributes<HTMLDivElement> {}

export function ApplicationsNav({ className, ...props }: ApplicationsNavProps) {
...
interface ApplicationsCodeLinkProps {
  pathname: string | null
}

export function ApplicationsCodeLink({ pathname }: ApplicationsCodeLinkProps) {
